export const ARTICLES = [
  ...
  { id: "11", title: "Orascom Construction Wins $1.2B Saudi Infrastructure Contract", source: "Mubasher", date: "2026-03-19T14:30:00Z", company: "Orascom", tag: "Infrastructure", sentiment: 3.7, importance: 7, summary: "Orascom Construction secured a major contract for infrastructure development in NEOM, Saudi's flagship mega-city project." },
  { id: "12", title: "MENA Tech Startups Raise $2.3B in Q1 2026", source: "TechCrunch", date: "2026-03-19T10:00:00Z", company: "MENA VC", tag: "Venture Capital", sentiment: 3.9, importance: 5, summary: "The MENA region's startup ecosystem continues to attract global investor interest with record Q1 funding." },
];
...
export const COMPANIES = [
  {
    ...
    sentiment: "neutral", articleCount: 156,
    tags: ["Banking", "Regulation", "Earnings", "Digital Banking"],
  ...
  },
  {
    ...
    sentiment: "positive", articleCount: 198,
    tags: ["Earnings", "Expansion", "Banking"],
  ...
  },
  {
    ...
    sentiment: "positive", articleCount: 89,
    tags: ["5G", "Infrastructure", "Revenue"],
...
export const SOURCES = [
  { id: "s1", name: "Reuters", category: "International Wire", enabled: true, articlesPerDay: 45, reliability: "high" },
  { id: "s2", name: "Bloomberg", category: "Financial News", enabled: true, articlesPerDay: 38, reliability: "high" },
  { id: "s3", name: "Financial Times", category: "Financial News", enabled: true, articlesPerDay: 22, reliability: "high" },
  { id: "s4", name: "Alborsa News", category: "Egypt Local", enabled: true, articlesPerDay: 30, reliability: "medium" },
  { id: "s5", name: "Mubasher", category: "MENA Finance", enabled: true, articlesPerDay: 25, reliability: "medium" },
  { id: "s6", name: "TechCrunch", category: "Technology", enabled: true, articlesPerDay: 15, reliability: "high" },
  { id: "s7", name: "Wall Street Journal", category: "Financial News", enabled: false, articlesPerDay: 20, reliability: "high" },
];
