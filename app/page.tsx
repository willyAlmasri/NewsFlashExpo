...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center py-10 px-4" style={{ background: "#0e0e0e" }}>
      {/* Header */}
      <div className="mb-8 text-center">
        ...
        <p className="text-[#6b6b6b] text-sm font-sans">MENA Financial Intelligence &middot; iOS/Android App</p>
      </div>
